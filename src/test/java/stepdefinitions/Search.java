...
public class Search {
	...
	public void user_enters_valid_product_into_search_box_field(String validProductText) {
		...
		homepage.enterValidSearch(validProductText);
	}
	...
	public void user_enters_invalid_product_into_search_box_field(String invalidProductText) {
		homepage = new HomePage(driver);
		homepage.enterInValidSearch(invalidProductText);
	}

	@When("User doesnt enter any product in search field")
	public void user_doesnt_enter_any_product_in_search_field() {
		homepage = new HomePage(driver);
	}
	...
	public void user_should_get_a_message_about_no_product_matching() {
		...
		Assert.assertEquals("There is no product that matches the search criteria.",
				searchpage.getNoProductMatchingMessage());
